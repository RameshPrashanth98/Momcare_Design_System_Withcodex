...
export type WeightHealthTrackingLayoutProps = {
  bloodPressureSection: ReactNode;
  bottomNavigation: ReactNode;
  contextHeader: ReactNode;
  fab: ReactNode;
  hemoglobinSection: ReactNode;
  summaryCard: ReactNode;
  topBar: ReactNode;
  weightSection: ReactNode;
};

export function WeightHealthTrackingLayout({ bloodPressureSection, bottomNavigation, contextHeader, fab, hemoglobinSection, summaryCard, topBar, weightSection }: WeightHealthTrackingLayoutProps) {
